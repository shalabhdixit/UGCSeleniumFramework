...
public class HtmlReportSupport {
	 ...
	 * TestEngine.timeStamp + ".html");// "SummaryReport.html" Writer writer =
	 * null;
	 * 
	 * if (file.exists()) { file.delete(); } writer = new FileWriter(file,
	 * true); try { writer.write("<!DOCTYPE html>"); writer.write("<html> ");
	 * writer.write("<head> "); writer.write("<meta charset='UTF-8'> ");
	 * writer.write
	 * ("<title>Quickflix - Automation Execution Results Summary</title>");
	 * 
	 * writer.write("<style type='text/css'>"); writer.write("body {");
	 * writer.write("background-color: #FFFFFF; ");
	 * writer.write("font-family: Verdana, Geneva, sans-serif; ");
	 * writer.write("text-align: center; "); writer.write("} ");
	 * 
	 * writer.write("small { "); writer.write("font-size: 0.7em; ");
	 * writer.write("} ");
	 * 
	 * writer.write("table { ");
	 ...
	 * writer.write("border-spacing: 0px; "); writer.write("width: 1000px; ");
	 * writer.write("margin-left: auto; ");
	 * writer.write("margin-right: auto; "); writer.write("} ");
	 * 
	 * writer.write("tr.heading { ");
	 * writer.write("background-color: #041944;");
	 * writer.write("color: #FFFFFF; "); writer.write("font-size: 0.7em; ");
	 * writer.write("font-weight: bold; "); writer.write(
	 ...
	 * writer.write("color: #000000; "); writer.write("font-weight: bold; ");
	 * writer.write("font-size: 0.7em; ");
	 * writer.write("text-align: justify; "); writer.write("} ");
	 * 
	 * writer.write("tr.section { ");
	 * writer.write("background-color: #A4A4A4; ");
	 * writer.write("color: #333300; "); writer.write("cursor: pointer; ");
	 * writer.write("font-weight: bold;"); writer.write("font-size: 0.8em; ");
	 * writer.write("text-align: justify;"); writer.write(
	 ...
	 * writer.write("} ");
	 * 
	 * writer.write("tr.subsection { "); writer.write("cursor: pointer; ");
	 * writer.write("} ");
	 * 
	 * writer.write("tr.content { ");
	 * writer.write("background-color: #FFFFFF; ");
	 * writer.write("color: #000000; "); writer.write("font-size: 0.7em; ");
	 * writer.write("display: table-row; "); writer.write("} ");
	 * 
	 ...
	 * writer.write("display: table-row; "); writer.write("} ");
	 * 
	 * writer.write("td, th { "); writer.write("padding: 5px; ");
	 * writer.write("border: 1px solid #4D7C7B; ");
	 * writer.write("text-align: inherit\0/; "); writer.write("} ");
	 * 
	 * writer.write("th.Logos { "); writer.write("padding: 5px; ");
	 * writer.write("border: 0px solid #4D7C7B; ");
	 * writer.write("text-align: inherit /;"); writer.write("} ");
	 * 
	 * writer.write("td.justified { "); writer.write("text-align: justify; ");
	 * writer.write("} ");
	 * 
	 * writer.write("td.pass {"); writer.write("font-weight: bold; ");
	 * writer.write("color: green; "); writer.write("} ");
	 * 
	 * writer.write("td.fail { "); writer.write("font-weight: bold; ");
	 * writer.write("color: red; "); writer.write("} ");
	 * 
	 * writer.write("td.done, td.screenshot { ");
	 * writer.write("font-weight: bold; "); writer.write("color: black; ");
	 * writer.write("} ");
	 * 
	 * writer.write("td.debug { "); writer.write("font-weight: bold; ");
	 * writer.write("color: blue; "); writer.write("} ");
	 * 
	 * writer.write("td.warning { "); writer.write("font-weight: bold; ");
	 * writer.write("color: orange; "); writer.write("} ");
	 * writer.write("</style> ");
	 * 
	 * writer.write("<script> "); writer.write("function toggleMenu(objID) { ");
	 * writer.write(" if (!document.getElementById) return;");
	 * writer.write(" var ob = document.getElementById(objID).style; ");
	 * writer.write("if(ob.display === 'none') { "); writer.write(" try { ");
	 * writer.write(" ob.display='table-row-group';");
	 * writer.write("} catch(ex) { "); writer.write("	 ob.display='block'; ");
	 * writer.write("} "); writer.write("} "); writer.write("else { ");
	 * writer.write(" ob.display='none'; "); writer.write("} ");
	 * writer.write("} "); writer.write("function toggleSubMenu(objId) { ");
	 * writer.write("for(i=1; i<10000; i++) { ");
	 * writer.write("var ob = document.getElementById(objId.concat(i)); ");
	 * writer.write("if(ob === null) { "); writer.write("break; ");
	 * writer.write("} "); writer.write("if(ob.style.display === 'none') { ");
	 * writer.write("try { "); writer.write(" ob.style.display='table-row'; ");
	 * writer.write("} catch(ex) { ");
	 * writer.write("ob.style.display='block'; "); writer.write("} ");
	 * writer.write(" } "); writer.write("else { ");
	 * writer.write("ob.style.display='none'; "); writer.write("} ");
	 * writer.write(" } "); writer.write("} "); writer.write("</script> ");
	 * writer.write("</head> ");
	 * 
	 * writer.write("<body> "); writer.write("</br>");
	 * 
	 * writer.write("<table id='Logos'>"); writer.write("<colgroup>");
	 * writer.write("<col style='width: 25%' />");
	 * writer.write("<col style='width: 25%' />");
	 * writer.write("<col style='width: 25%' />");
	 * writer.write("<col style='width: 25%' />"); writer.write("</colgroup> ");
	 * writer.write("<thead> ");
	 * 
	 * writer.write("<tr class='content'>");
	 * writer.write("<th class ='Logos' colspan='2' >");
	 * writer.write("<img align ='left' src= ./Screenshots//" +
	 * config.getProperty("Client_logo") + ".png></img>");
	 * writer.write("</th>");
	 * writer.write("<th class = 'Logos' colspan='2' > ");
	 * writer.write("<img align ='right' src= .//Screenshots//cigniti.png></img>"
	 * ); writer.write("</th> "); writer.write("</tr> ");
	 * 
	 * writer.write("</thead> "); writer.write("</table> ");
	 * 
	 * writer.write("<table id='header'> "); writer.write("<colgroup> ");
	 * writer.write("<col style='width: 25%' /> ");
	 * writer.write("<col style='width: 25%' /> ");
	 * writer.write("<col style='width: 25%' /> ");
	 * writer.write(" <col style='width: 25%' /> ");
	 ...
	 * writer.write("<thead> ");
	 * 
	 * writer.write("<tr class='heading'> "); writer.write(
	 ...
	 * writer.write("<th>NextTestCase</th> "); writer.write("</tr> ");
	 * 
	 * 
	 * writer.write("<tr class='subheading'> ");
	 * writer.write("<th>&nbsp;Suite Executed&nbsp;:&nbsp;</th> ");
	 * writer.write("<th>Regression</th> ");
	 * writer.write("<th>&nbsp;Browser&nbsp;:</th> "); writer.write("<th>" +
	 * configProps.getProperty("browserType")+ "</th> ");
	 * writer.write("</tr> ");
	 * 
	 * 
	 * writer.write("<tr class='subheading'> ");
	 * writer.write("<th>&nbsp;Host Name&nbsp;:</th> "); writer.write("<th>" +
	 * InetAddress.getLocalHost().getHostName()+ "</th> ");
	 * writer.write("<th>&nbsp;No.&nbsp;Of&nbsp;Threads&nbsp;:&nbsp;</th> ");
	 * writer.write("<th>" + "NA" + "</th> "); writer.write("</tr> ");
	 * 
	 * writer.write("<tr class='subheading'> ");
	 * writer.write("<th colspan='4'> "); writer.write("&nbsp;Environment -  " +
	 * configProps.getProperty("URL") + ""); writer.write("</th> ");
	 * writer.write("</tr> "); writer.write("</thead> ");
	 * writer.write("</table> "); writer.write("<table id='main'> ");
	 * writer.write("<colgroup> "); writer.write("<col style='width: 5%' /> ");
	 * writer.write("<col style='width: 35%' /> ");
	 * writer.write("<col style='width: 42%' /> ");
	 * writer.write("<col style='width: 10%' /> ");
	 * writer.write("<col style='width: 8%' /> "); writer.write("</colgroup> ");
	 * writer.write("<thead> "); writer.write("<tr class='heading'> ");
	 * writer.write("<th>S.NO</th> "); writer.write("<th>Test Case</th> ");
	 * writer.write("<th>Description</th> "); writer.write("<th>Time</th> ");
	 * writer.write("<th>Status</th> "); writer.write("</tr> ");
	 * writer.write("</thead> "); Iterator<Entry<String, String>> iterator1 =
	 * map.entrySet() .iterator(); int serialNo = 1; while (iterator1.hasNext())
	 * { Map.Entry mapEntry1 = (Map.Entry) iterator1.next(); key =
	 * mapEntry1.getKey().toString().split(":"); String value = (String)
	 * mapEntry1.getValue(); writer.write("<tbody> ");
	 * writer.write("<tr class='content2' > ");
	 * writer.write("<td class='justified'>" + serialNo + "</td>"); if
	 * (value.equals("PASS")) {
	 * writer.write("<td class='justified'><a href='"+key[1]+"_Results_" +
	 * TestEngine.timeStamp + ".html#'" + "' target='about_blank'>" + key[1] +
	 * "</a></td>"); } else {
	 * writer.write("<td class='justified'><a href='"+key[1]+"_Results_" +
	 * TestEngine.timeStamp + ".html'" + " target='about_blank'>" + key[1] +
	 * "</a></td>"); }
	 ...
	 * "</td>"); writer.write("<td>" + executionTime.get(key[1])+
	 * " Seconds</td>"); if(TestEngine.testResults.get(key[1]).equals("PASS"))
	 * writer.write("<td class='pass'>Passed</td> "); else
	 * writer.write("<td class='fail'>Failed</td> "); writer.write("</tr>");
	 * writer.write("</tbody> "); serialNo = serialNo + 1; } writer.flush();
	 * writer.close();
	 * 
	 * } catch (Exception e) { writer.flush(); writer.close(); }
	 * 
	 * }
	 */
	...
	public static void createHtmlSummaryReport(String browser) throws Exception {
		...
		try {
			...
			writer.write("<title>MIGNG - Automation Execution Results Summary</title>");
			...
			writer.write("MIGNG - Automation Execution Result Summary ");
			writer.write("</th> ");
			writer.write("</tr> ");
			writer.write("<tr class='subheading'> ");
			writer.write("<th>&nbsp;Date&nbsp;&&nbsp;Time&nbsp;:&nbsp;" + ""
...
//			writer.write("<th>" + configProps.getProperty("browserType") + "</th> ");
			writer.write("<th>" + browser + "</th> ");
			writer.write("</tr> ");
			...
			while (iterator1.hasNext()) {
				...
				if (key[1].contains(browser)) {
					...
					if (value.equals("PASS")) {
						writer.write("<td class='justified'><a href='" + key[1]
								+ "_Results.html#'" + "' target='about_blank'>"
	...
	public void htmlCreateReport() throws Exception {
		// map.clear();
		File file = new File(TestEngine.filePath() + "/" + strTestName + "_Results" + ".html");
		if (file.exists()) {
			file.delete();
		}
	}
