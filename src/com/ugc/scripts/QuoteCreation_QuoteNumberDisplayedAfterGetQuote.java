...
public class QuoteCreation_QuoteNumberDisplayedAfterGetQuote extends BusinessFunctions {
	@Test(dataProvider = "get_TestData")
	public void QuoteCreation_QuoteNumber_Displayed_After_GetQuote (String borrowerLastName,
		...
		try {
			...
			if (createNewQuote(borrowerLastName, lenderLoanNumber,
					...
					financedPremium, upFrontPremium, postPay, "BPA")) {
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_BPA");
	}
}
