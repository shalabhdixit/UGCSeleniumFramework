...
public class NewApplication_CreateNewApplication_BPSM extends BusinessFunctions {

	@Test(dataProvider = "get_TestData")
	public void New_Application_Create_New_Application_BPSM(String secureQuoteNumber,
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewApplication_BPSM");
	}
}