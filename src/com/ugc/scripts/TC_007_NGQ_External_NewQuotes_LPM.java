...
public class TC_007_NGQ_External_NewQuotes_LPM extends BusinessFunctions{
	@Test(dataProvider = "get_TestData")
	public void TC_007_NGQ_External_New_Quote_LPM (String borrowerLastName,
		...
		try {
			...
			if (createNewQuote(borrowerLastName, lenderLoanNumber,
					...
					financedPremium, upFrontPremium, postPay, "LPM")) {
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_LPM");
	}
}
