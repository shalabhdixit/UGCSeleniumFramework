...
public class TC_004_NGQ_External_NewQuotes_BPSR extends BusinessFunctions {
	@Test(dataProvider = "get_TestData")
	public void TC_004_NGQ_External_New_Quote_BPSR (String borrowerLastName,
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_BPSR");
	}
}
