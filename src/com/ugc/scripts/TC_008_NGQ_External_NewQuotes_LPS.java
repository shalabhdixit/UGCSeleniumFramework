...
public class TC_008_NGQ_External_NewQuotes_LPS extends BusinessFunctions {
	@Test(dataProvider = "get_TestData")
	public void TC_008_NGQ_External_New_Quote_LPS (String borrowerLastName,
		...
		try {
			...
			if (createNewQuote(borrowerLastName, lenderLoanNumber,
					...
					financedPremium, upFrontPremium, postPay, "LPS")) {
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_LPS");
	}
}
