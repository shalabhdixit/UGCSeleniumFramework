...
public class TC_003_NGQ_External_NewQuotes_BPSNR extends BusinessFunctions{
	@Test(dataProvider = "get_TestData")
	public void TC_003_NGQ_External_New_Quote_BPSNR (String borrowerLastName,
		...
		try {
			...
			if (createNewQuote(borrowerLastName, lenderLoanNumber,
					...
					financedPremium, upFrontPremium, postPay, "BPSNR")) {
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_BPSNR");
	}
}
