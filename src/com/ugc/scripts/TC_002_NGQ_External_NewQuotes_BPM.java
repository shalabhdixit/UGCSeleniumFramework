...
public class TC_002_NGQ_External_NewQuotes_BPM extends BusinessFunctions{
	@Test(dataProvider = "get_TestData")
	public void TC_002_NGQ_External_New_Quote_BPM (String borrowerLastName,
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_BPM");
	}
}
