...
public class TC_005_NGQ_External_NewQuotes_BPSplit extends BusinessFunctions{
	@Test(dataProvider = "get_TestData")
	public void TC_005_NGQ_External_New_Quote_BPSplit (String borrowerLastName,
		...
		try {
			...
			if (createNewQuote(borrowerLastName, lenderLoanNumber,
					...
					financedPremium, upFrontPremium, postPay, "BPS")) {
	...
	public Object[][] get_TestData() throws Exception {
		return Data_Provider.getTableArray("CreateNewQuote_BPS");
	}
}
